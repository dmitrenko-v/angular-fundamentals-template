...
export class AppComponent implements OnInit, OnDestroy {
  ...
  loadCharactersAndPlanet(): void {
    ...
    this.planetAndCharactersResults$ = forkJoin([this.mockDataService.getPlanets(), this.mockDataService.getCharacters()])
        .pipe(map(([planets, characters]) => planets.concat(characters)));
  ...
  initLoadingState(): void {
    ...
    const combinedLoaders$ = combineLatest([characterLoader$, planetLoader$]);
    
    this.subscriptions.push(combinedLoaders$.subscribe((loadingResults) => this.isLoading = this.areAllValuesTrue(loadingResults)));
